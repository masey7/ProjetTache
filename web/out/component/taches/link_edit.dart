...
class LinkEdit extends WebComponent {
  ...
  static final __shadowTemplate = new autogenerated.DocumentFragment.html('''
        <div>
          ...
          <br>
          <button id="__e-38">Update</button>
          <span id="edit-link-message"></span>
        </div>
      ''');
  autogenerated.ButtonElement __e38;
  autogenerated.InputElement __e37, __editLinkDescription, __editLinkUrl;
  autogenerated.SpanElement __e36, __editLinkMessage;
  ...
  void created_autogenerated() {
    ...
    __t.oneWayBind(() =>  link.code , (e) { __e37.value = e; }, false, false);
    ...
    __t.listen(__e38.onClick, ($event) { update(); });
  ...
  void removed_autogenerated() {
    __t.remove();
    __t = __e36 = __e37 = __editLinkUrl = __editLinkDescription = __e38 = __editLinkMessage = null;
  }
