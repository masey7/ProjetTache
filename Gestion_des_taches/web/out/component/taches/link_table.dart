...
class LinkTable extends WebComponent {
  ...
  void created_autogenerated() {
    ...
    __t.conditional(__e22, () => showLinkAdd, (__t) {
      var __e20, __e21;
      __e21 = new autogenerated.Element.html('<div template="" if="showLinkAdd">\n          <x-link-add id="__e-20">\n          </x-link-add>\n        </div>');
    ...
    __t.conditional(__e25, () => showLinkEdit, (__t) {
      var __e23, __e24;
      __e24 = new autogenerated.Element.html('<div template="" if="showLinkEdit">\n          <x-link-edit id="__e-23">\n          </x-link-edit>\n        </div>');
