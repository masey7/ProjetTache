...
class CategoryTable extends WebComponent {
  ...
  void created_autogenerated() {
    ...
    __t.loop(__e15, () => categories.toList(), (category, __t) {
      ...
      __t.conditional(__e8, () => display(category), (__t) {
      ...
      __t.conditional(__e14, () => !display(category), (__t) {
    ...
    __t.conditional(__e19, () => showCategoryLinks, (__t) {
      ...
      __t.component(new LinkTable.forElement(__e17));
    __t.add(__e18);
    });
